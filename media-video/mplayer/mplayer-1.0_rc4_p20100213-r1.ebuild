...
# $Header: /var/cvsroot/gentoo-x86/media-video/mplayer/mplayer-1.0_rc4_p20100213-r1.ebuild,v 1.1 2010/02/27 23:37:39 sping Exp $
...
+cddb +cdio cdparanoia +coreavc  cpudetection custom-cpuopts debug dga +dirac directfb
...
RDEPEND+="
	...
	coreavc? ( media-libs/dshowserver )
...
src_prepare() {
	...
	# CoreAVC support
	use coreavc && epatch "${FILESDIR}/dshowserver.patch"
